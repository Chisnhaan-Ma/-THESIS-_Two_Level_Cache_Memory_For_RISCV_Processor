        ...
        if (i_reset) begin
            ...
            if (current_state == REFILL) begin
                ...
                if (miss_wr_en_reg) begin
                    data_array[miss_index_reg][victim_way_reg] <= write_with_mask(i_cache_l2_rdata, miss_wdata_reg, miss_byte_mask_reg);
                    dirty[miss_index_reg][victim_way_reg] <= 1'b1;
                end else begin
                    data_array[miss_index_reg][victim_way_reg] <= i_cache_l2_rdata;
